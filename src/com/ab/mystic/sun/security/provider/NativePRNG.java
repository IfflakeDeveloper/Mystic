...
package com.ab.mystic.sun.security.provider;
...
public final class NativePRNG extends SecureRandomSpi {
    ...
    private static class RandomIO {
        ...
        private volatile com.ab.mystic.sun.security.provider.SecureRandom mixRandom;
        ...
        private com.ab.mystic.sun.security.provider.SecureRandom getMixRandom() {
        	com.ab.mystic.sun.security.provider.SecureRandom r = mixRandom;
            if (r == null) {
                synchronized (LOCK_GET_BYTES) {
                    r = mixRandom;
                    if (r == null) {
                        r = new com.ab.mystic.sun.security.provider.SecureRandom();
                        try {
                            byte[] b = new byte[20];
