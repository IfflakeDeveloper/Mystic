...
import com.ab.mystic.net.f5.crypt.F5Random;
import com.ab.mystic.net.f5.crypt.Permutation;
import com.ab.mystic.net.f5.ortega.HuffmanDecode;
...
public class Extract {
    ...
    public ByteArrayOutputStream fos; // embedded file (output file)
    ...
    public void extract(InputStream fis, int flength, ByteArrayOutputStream fos)
        ...
        if (nBytesExtracted < extractedFileLength) {
			...
			builder.setMessage(fos.toString())
